...
public class DataManager {
	...
	private static String base = "plugins/"+Main.getInstance().getDescription().getName()+"/data/";
	...
	public static File getFolder(DataType type) {
		File f = new File(base+type.getSrc());
		if (f.exists()) {
			return f;
		}
		return null;
	...
	public static void deleteFile(DataType type, String name) {
		File f = new File(base+type.getSrc() + "/" + name);
		f.delete();
	}
